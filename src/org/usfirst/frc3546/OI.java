...
public class OI {
    ...
    public OI() {
        ...
        climbingArmRetractButton.whileHeld(new ClimbingArmRetract());
        ...
        SmartDashboard.putData("ClimbingArmRotateToggle", new ClimbingArmRotateToggle());
